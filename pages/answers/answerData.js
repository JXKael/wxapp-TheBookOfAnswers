function answerData() {
  ...
  this.answers = [
    ...
    { content: "宛在水中央", subContent: "取自《诗经·蒹葭》", exp: "顺势" },
    ...
    { content: "地利不如人和", subContent: "取自《孟子·公孙丑章句下》", exp: "万事兴" },
    ...
    { content: "辩荣辱之境", subContent: "改自《庄子·逍遥游》", exp: "名誉" },
    { content: "依天理", subContent: "改自《庄子·养生主》", exp: "修心" },
    ...
    { content: "知彼知己", subContent: "改自《孙子·谋攻篇》", exp: "信息对称" },
    { content: "同欲", subContent: "改自《孙子·谋攻篇》", exp: "目标一致" },
    ...
    { content: "未能远谋", subContent: "取自《左传·庄公十年》", exp: "看得更远" },
    ...
    { content: "戏言", subContent: "取自《史记·晋世家》", exp: "玩笑话" },
    ...
    { content: "定不负相思意", subContent: "取自《卜算子·我住长江头》", exp: "不负平生" },
    { content: "效穷途之哭", subContent: "取自《滕王阁序》", exp: "哭一场会好受点" },
    { content: "金缕衣和少年时", subContent: "改自《金缕衣》", exp: "浪费时间" },
    ...
    { content: "使我不得开心颜", subContent: "取自《梦游天咾呤留别》", exp: "这会带来痛苦" },
    ...
    { content: "只有香如故", subContent: "取自《卜算子·咏梅》", exp: "学会自我欣赏" },
    ...
    { content: "放浪形骸之外", subContent: "取自《兰亭集序》", exp: "别太委屈自己" },
    ...
    { content: "人非生而知之", subContent: "改自《师说》", exp: "学习" },
    { content: "精，于勤", subContent: "改自《进学解》", exp: "勤勉" },
    { content: "虽爱之，实害之", subContent: "改自《种树郭橐驼传》", exp: "爱，有时候也是一种伤害" },
    ...
    { content: "醉翁之意不在酒", subContent: "取自《醉翁亭记》", exp: "山水之间" },
    ...
    { content: "惟有泪千行", subContent: "取自《江城子·乙卯正月二十日夜记梦》", exp: "无言" },
    { content: "如今俱是异乡人", subContent: "取自《荷叶杯·记得那年花下》", exp: "无因" },
    { content: "为有暗香来", subContent: "取自《梅花》", exp: "夜来香" },
    ...
    { content: "世味薄似纱", subContent: "改自《临安春雨初霁》", exp: "内心温暖" },
    ...
    { content: "能饮一杯无", subContent: "取自《问刘十九》", exp: "和朋友来一杯" },
    { content: "润物细无声", subContent: "取自《春夜喜雨》", exp: "改变悄悄发生" },
    { content: "一岁一枯荣", subContent: "取自《赋得古原草送别》", exp: "再生" },
    { content: "门始为君开", subContent: "取自《客至》", exp: "迎送" },
    ...
    { content: "天生我材必有用", subContent: "取自《将进酒·君不见》", exp: "是材不是才" },
    { content: "徒劳恨费声", subContent: "取自《蝉》", exp: "无用功" },
    { content: "幽人应未眠", subContent: "取自《秋夜寄邱员外》", exp: "等待" },
    { content: "坐观垂钓者", subContent: "取自《望洞庭湖赠张丞相》", exp: "羡" },
